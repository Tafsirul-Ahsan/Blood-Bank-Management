...
<body>
  <section class="justify-content-center">
      ...
      @foreach($keys as $key)
        <div class="msg-box">
          ...
          <div class="flr">
            ...
            <span class="timestamp"><span class="username">Admin</span>&bull;<span class="posttime">Now</span></span>
          </div>
        </div>
        @endforeach
      </article>
    ...
    <form class="chat-input" action="{{url('store')}}" method="post">
        @csrf
